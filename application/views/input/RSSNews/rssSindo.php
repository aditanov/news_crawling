  ...
  foreach (sindoNews($url) as $article)
  {
    ...
    ?>
      <form id="form<?php echo $i;?>"action="<?php echo base_url('index.php/C_input/AddNewsRSS');?>" target="_self" method="POST">
              ...
              </p><p><input type="text" name="media" value="sindo"></input>
...
$i = form_input('http://nasional.sindonews.com/rss',0);
?>
