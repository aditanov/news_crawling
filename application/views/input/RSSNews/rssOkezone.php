<?php
/************************************ LAKUKAN INSERT SETIAP 3 JAM SEKALI ***********************************/
function okezoneNews($url){
...
function form_input($url,$i)
{
  ...
  foreach (okezoneNews($url) as $article)
  {
    $i++;
    ...
    ?>
      <form id="form<?php echo $i;?>"action="<?php echo base_url('index.php/C_input/AddNewsRSS');?>" target="_self" method="POST">
              ...
              </p><p><input type="text" name="image" value='<?php echo $article['image'];?>'></input>
              ...
              </p><p><input type="text" name="media" value="okezone"></input>
...
$i = form_input('http://sindikasi.okezone.com/index.php/rss/1/RSS2.0',0);
