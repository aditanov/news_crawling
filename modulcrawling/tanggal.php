...
function Ambilgambar($url,$awal,$akhir){
...
$gambar=Ambilgambar($url,'<meta property="og:image" content="','" />');//gambar
if ($gambar == NULL){
	$gambar = "";
}
else{
...
date_default_timezone_set("Asia/Jakarta");
    ...
    mktime(10, 10, 0, 11, 22, 2013);
      //echo substr($jam1, 8, 2)."-".substr($jam1, 5, 2)."-".substr($jam1, 0, 4);
      echo $jam1;
      echo $tgl;
    //$jam2="$jam1";

  echo $lokasi;
    $query = "INSERT INTO berita3(judul, tanggal, jam, isi, penulis, url, lokasi, gambar) VALUES('" . $judul . "', '" . $tgl . "','" . $jam1 . "','" . $isi . "','" . $penulis . "', '" . $url . "', '" . $lokasi . "', '" . $gambar . "')";
        ...
        pucrintf ("These values were inserted into the database - %s %s %s");
        pg_close();
